...
func TestRegisterHandlerVulnerabilities(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			method:         http.MethodPost,
			payload:        `{"nickname":"bobby","first_name":"Bob","last_name":"Doe","password":"password123456","age":25,"gender":"male"}`,
			expectedStatus: http.StatusBadRequest,
		},
		{
			name:           "Bug 4: Enforce Non-Zero Integer Fields (Age is 0)",
			method:         http.MethodPost,
			payload:        `{"nickname":"bobby","first_name":"Bob","last_name":"Doe","email":"bob@test.com","password":"password123456","age":0,"gender":"male"}`,
			expectedStatus: http.StatusBadRequest,
		},
		{
			name:           "Reject password shorter than 12 characters",
			method:         http.MethodPost,
			payload:        `{"nickname":"shortpw","first_name":"Bob","last_name":"Doe","email":"shortpw@test.com","password":"short1","age":25,"gender":"male"}`,
			expectedStatus: http.StatusBadRequest,
			expectedBody:   "password must be at least 12 characters long",
		},
		{
			name:           "Bug 5: Collision Catch - Nickname Already Taken",
			method:         http.MethodPost,
			payload:        `{"nickname":"existing_user","first_name":"Bob","last_name":"Doe","email":"unique@email.com","password":"password123456","age":25,"gender":"male"}`,
		...
		},
		{
			...
			method:         http.MethodPost,
			payload:        `{"nickname":"unique_user","first_name":"Bob","last_name":"Doe","email":"taken@email.com","password":"password123456","age":25,"gender":"male"}`,
			expectedStatus: http.StatusConflict,
		...
		},
		{
			...
			method:         http.MethodPost,
			payload:        `{"nickname":"niko@test","first_name":"Niko","last_name":"M","email":"niko@test.com","password":"secret123456","age":30,"gender":"male"}`,
			expectedStatus: http.StatusBadRequest,
		...
		},
		{
			...
			method:         http.MethodPost,
			payload:        `{"nickname":"niko","first_name":"Niko","last_name":"M","email":"nikotestcom","password":"secret123456","age":30,"gender":"male"}`,
			expectedStatus: http.StatusBadRequest,
